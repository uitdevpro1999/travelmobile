...
class OrderDetail {
  ...
  String status;
  // alll othervarialble...
  List<OrderStoreDetail>? orderStoreDetailEntities;
  //initilize all in constructor
  OrderDetail({ required this.userId,required this.totalPrice,required this.receiverName,required this.email,required this.phone,required this.houseNumberStreet,required this.address,required this.paymentMethod,required this.shipmentMethod,required this.id ,required this.orderStoreDetailEntities,required this.status });
  @override
